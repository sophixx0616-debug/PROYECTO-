                ...
                <div class="card-body p-5">
                    ...
                    <?php if($cart && count($cart) > 0): ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-4 border-top">
                            <div>
                                ...
                                <h2 class="fw-bold" style="color: #6f7f5d;">$<?php echo e(number_format($total, 0, ',', '.')); ?></h2>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?php echo e(route('services.index')); ?>" class="btn btn-confirmar shadow-sm fw-bold text-decoration-none">
