        ...
        <div class="col-md-4 mb-4">
            ...
            <div class="card glass-card spa-card">
                ...
                <div class="card-body text-center p-4">
                    ...
                    <img src="<?php echo e(asset('images/spa.jpg')); ?>"
                    ...
                    <form action="<?php echo e(route('appointments.store')); ?>" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="time"
                                ...
                                <option value="<?php echo e($hour); ?>"
                                <?php echo e(in_array($hour, $takenTimes ?? []) ? 'disabled' : ''); ?>>

                                    <?php echo e($hour); ?>


                                    <?php echo e(in_array($hour, $takenTimes ?? []) ? '(ocupado)' : ''); ?>
    ...
    <select name="worker"
        ...
        <?php $__currentLoopData = $specialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <option value="<?php echo e($specialist->name); ?>">
                <?php echo e($specialist->name); ?> - <?php echo e($specialist->specialty); ?>
...
<div class="alert alert-light border mb-4">
    ...
    <?php $__currentLoopData = $specialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <p class="mb-2">
            ...
            <strong><?php echo e($specialist->name); ?>:</strong>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danna\OneDrive\Documentos\GitHub\PROYECTO-NUEVO\resources\views/appointments/create.blade.php ENDPATH**/ ?>