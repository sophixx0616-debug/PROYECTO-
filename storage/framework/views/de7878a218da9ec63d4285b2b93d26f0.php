...
<div class="appointments-card mt-4">
    ...
    <div class="table-responsive">
        ...
        <table class="table">
            ...
            <?php $__currentLoopData = $ultimasCitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <tr>
                    <td><?php echo e($cita->user->name ?? 'N/A'); ?></td>
                    <td><?php echo e($cita->service->name ?? 'N/A'); ?></td>
                    <td><?php echo e($cita->date); ?></td>
                    <td><?php echo e($cita->time); ?></td>

                    <td>

                        <?php if(strtolower($cita->status) == 'confirmada'): ?>

                            <span class="badge-confirmada">
                                Confirmada
                            </span>

                        <?php elseif(strtolower($cita->status) == 'pendiente'): ?>
...
<div class="appointments-card mt-4">
    ...
    <?php if(isset($misCitas) && $misCitas->count()): ?>
        ...
        <div class="table-responsive">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $misCitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
